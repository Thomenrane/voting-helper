    ...
    methodology: {
      ...
      formula: {
        ...
        steps: [
          ...
          'Le score vaut 100 × (1 − cette moyenne), arrondi à l’entier le plus proche — à égalité, x,5 est arrondi vers le haut.',
    ...
    methodology: {
      ...
      formula: {
        ...
        steps: [
          ...
          'De score is 100 × (1 − dat gemiddelde), afgerond op het dichtstbijzijnde gehele getal — bij gelijke afstand wordt x,5 naar boven afgerond.',
